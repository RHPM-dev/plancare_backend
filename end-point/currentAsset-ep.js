...
exports.handleAddFixedAsset = async (req, res) => {
    ...
    try {
        ...
        if (existingAssets.length > 0) {
            ...
            const updatedValues = [updatedNumOfUnits, updatedTotalPrice, volumeInt, unitPrice, formattedPurchaseDate, formattedExpireDate, status];
            ...
            // Insert new asset
            const insertValues = [userId, category, asset, brand, batchNum, unit, volumeInt, numberOfUnits, unitPrice, totalPrice, formattedPurchaseDate, formattedExpireDate, status];
